...
public class OverallStandingsTest {
  ...
  private Heat createHeat(
    ...
    for (int i = 0; i < laps1; i++) {
      d1.addLap(time1 / laps1, false, true);
    }

    DriverHeatData d2 = new DriverHeatData(p2);
    for (int i = 0; i < laps2; i++) {
      d2.addLap(time2 / laps2, false, true);
    }
    ...
    return new Heat(number, dhdList, scoring, false);
  }
  ...
  public void testTiebreakers() {
    ...
    os = new OverallStandings(heatScoring, overallScoring, new GroupOptions(), false);
    ...
    dhdList.add(d1);
    dhdList.add(d2);
    heats.add(new Heat(1, dhdList, heatScoring, false));
  ...
  public void testMinAdvancingSimple() {
    ...
    OverallStandings os = new OverallStandings(heatScoring, overallScoring, groupOptions, false);
