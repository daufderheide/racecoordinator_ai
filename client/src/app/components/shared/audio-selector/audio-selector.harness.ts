...
export class AudioSelectorHarness extends ComponentHarness implements AudioSelectorHarnessBase {
  static hostSelector = 'app-audio-selector';

  protected getLabelElement = this.locatorForOptional('.audio-header label');
  protected getToggleSpans = this.locatorForAll('.toggle-group span');
  protected getSelectWrapper = this.locatorForOptional('.select-wrapper');
  protected getSelectedSoundNameElement = this.locatorForOptional('.dm-select');
  protected getTtsInput = this.locatorForOptional('input.dm-input');
  protected getPlayButton = this.locatorForOptional('.btn-play');
