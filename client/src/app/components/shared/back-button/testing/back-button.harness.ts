...
export class BackButtonHarness extends ComponentHarness implements BackButtonHarnessBase {
  static hostSelector = 'app-back-button';

  protected getButton = this.locatorFor('.back-btn');
  protected getConfirmModalConfirmButton = () => document.querySelector('app-confirmation-modal .btn-confirm') as HTMLElement | null;
  protected getConfirmModalCancelButton = () => document.querySelector('app-confirmation-modal .btn-cancel') as HTMLElement | null;
