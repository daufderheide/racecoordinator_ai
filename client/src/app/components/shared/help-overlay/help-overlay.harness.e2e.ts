...
export class HelpOverlayHarnessE2e implements HelpOverlayHarnessBase {
  ...
  private get overlayContainer() { return this.locator.locator('.help-overlay-container'); }
  private get titleElement() { return this.locator.locator('.popover-header h3'); }
  private get contentElement() { return this.locator.locator('.popover-content'); } // Using container to get inner text
  private get nextButton() { return this.locator.locator('.btn-next'); }
  private get prevButton() { return this.locator.locator('.btn-prev'); }
  private get finishButton() { return this.locator.locator('.btn-finish'); }
  private get closeButton() { return this.locator.locator('.close-btn'); }
  private get stepCounterElement() { return this.locator.locator('.step-counter'); }
  private get highlightMask() { return this.locator.locator('.highlight-mask'); }
  private get popover() { return this.locator.locator('.help-popover'); }
