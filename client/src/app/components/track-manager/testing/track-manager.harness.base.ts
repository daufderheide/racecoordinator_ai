...
import { CameraSummaryHarnessBase } from "../camera-summary/testing/camera-summary.harness.base";
...
export abstract class TrackManagerHarnessBase {
  ...
  abstract getCameraSummaryHarnesses(): Promise<CameraSummaryHarnessBase[]>;
