...
1. Inicie o **ngrok** no seu computador: `ngrok http 4200`
2. Abra a URL `https://...` gerada no seu iPhone. Por contar com certificado SSL oficial, o iOS solicitará a permissão de câmera de imediato.
