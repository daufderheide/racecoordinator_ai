...
- **Enregistrer les modifications** : En cliquant sur l'icône **Fin de modification** (œil / terminé), les modifications sont validées, enregistrées sur le serveur et l'éditeur repasse en mode lecture seule.
