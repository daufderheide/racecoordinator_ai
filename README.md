...
> 🚀 **Current Latest Version**: **`v1.0.0-beta.87`** *(Beta Preview — Help us test upcoming features!)*

Click your operating system below to **download directly**:

| Operating System | ⬇️ Direct Download Link | Version | Package Type |
| :--- | :--- | :--- | :--- |
| **🪟 Windows (10 / 11)** | [**⬇️ Download Windows Setup**](https://github.com/daufderheide/racecoordinator_ai/releases/download/v1.0.0-beta.87/RaceCoordinatorAI_Online_Setup_v1.0.0-beta.87.exe) | `v1.0.0-beta.87` | Online Setup *(Fast, requires internet)* |
| **🪟 Windows (8, 7, XP / Offline)** | [**⬇️ Download Offline Setup**](https://github.com/daufderheide/racecoordinator_ai/releases/download/v1.0.0-beta.87/RaceCoordinatorAI_Offline_Setup_v1.0.0-beta.87.exe) | `v1.0.0-beta.87` | Full Offline Standalone *(Required for Win 8 & older)* |
| **🍏 macOS (Intel & Apple Silicon)** | [**⬇️ Download macOS DMG**](https://github.com/daufderheide/racecoordinator_ai/releases/download/v1.0.0-beta.87/RaceCoordinator_Mac_v1.0.0-beta.87.dmg) | `v1.0.0-beta.87` | Disk Image (`.dmg`) |
| **🐧 Linux / Raspberry Pi / Arduino Uno Q (ARM64)** | [**⬇️ Download Linux Package**](https://github.com/daufderheide/racecoordinator_ai/releases/download/v1.0.0-beta.87/RaceCoordinatorAI-Linux-ARM64_v1.0.0-beta.87.tar.gz) | `v1.0.0-beta.87` | Tarball (`.tar.gz`) |
